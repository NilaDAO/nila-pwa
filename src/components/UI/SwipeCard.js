              ...
              { compact ? (
                <div className="flex flex-row items-center gap-3">
                    <div className="relative flex items-center justify-center h-8 w-8 flex-shrink-0">
                        ...
                        {t.urgent && (
                            <span className="absolute inset-0 m-auto h-7 w-7 rounded-full bg-red opacity-60 animate-ping" />
                        )}
                        {t.cropImg ? (
                            <div className={`relative h-7 w-7 rounded-full flex items-center justify-center ${t.iconBg || 'bg-green'} flex-shrink-0`}>
                ...
                <div className="flex justify-center mb-2">
                    <div className="relative flex items-center justify-center h-12 w-12">
                        ...
                        {t.urgent && (
                            <span className="absolute inset-0 m-auto h-10 w-10 rounded-full bg-red opacity-60 animate-ping" />
                        )}
                        {t.cropImg ? (
                            <div className={`relative h-10 w-10 rounded-full flex items-center justify-center ${t.iconBg || 'bg-green'} flex-shrink-0`}>
